...
from pong_manon import RESOLUTION, PongPlayer, PongSprite, PongBall, UILayer
# --- constants ---
...
ui_layer = UILayer(ball,p1,P1_COLOR,p2,P2_COLOR)

game = Game()
game.add(playground, game_layer,ui_layer)
