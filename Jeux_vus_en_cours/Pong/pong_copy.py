...
# On pourrait aussi créer une classe Score().
# Mais! On devrait quand même appeler cette fonction
# dans PongBall... Ou dans PongGame()
#  On revient à la solution préconisée par 
# Thomas et Bastien.
